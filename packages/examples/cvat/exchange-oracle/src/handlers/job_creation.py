...
from src.core.types import CvatLabelType, TaskStatuses, TaskTypes
...
LABEL_TYPE_MAPPING = {
    TaskTypes.image_label_binary: CvatLabelType.tag,
    TaskTypes.image_points: CvatLabelType.points,
    TaskTypes.image_boxes: CvatLabelType.rectangle,
    TaskTypes.image_boxes_from_points: CvatLabelType.rectangle,
    TaskTypes.image_skeletons_from_boxes: CvatLabelType.points,
}
